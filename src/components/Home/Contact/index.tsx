        ...
        <div className='grid md:grid-cols-12 grid-cols-1 md:gap-7 gap-0'>
          <div
            ...
            <h2 className='sm:text-4xl text-[28px] leading-tight font-bold text-white py-12'>
              Let’s build, edit, or shape something creative together.
            </h2>
            <div className='grid grid-cols-6 pb-12 border-b border-dark_border '>
              <div className='col-span-3'>
                <span className='text-white/50 text-lg'>Instagram</span>
                <p className='bg-transparent border-0 text-white text-lg'>
                  harikrishnan_._25
                </p>
              </div>
              <div className='col-span-3'>
                <span className='text-white/50 text-lg'>LinkedIn</span>
                <p className='bg-transparent border-0 text-white text-lg'>
                  Harikrishnan N
                </p>
              </div>
              <div className='col-span-6 pt-8'>
                <span className='text-white/50 text-lg'>Focus</span>
                <p className='bg-transparent border-0 text-white text-lg'>
                  Full Stack Development, Cloud Computing, Video Editing
                </p>
              </div>
            </div>
            <div className='pt-12'>
